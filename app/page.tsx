                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
                        <div>
                            ...
                            <p className='text-xl mb-8 text-primary-foreground/80'>
                                Shop from thousands of products with fast
                                delivery, secure payments, and unbeatable
                                prices.
                            </p>
                            ...
                            <div className='bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-8 border border-primary-foreground/20'>
                                <div className='grid grid-cols-2 gap-4'>
                                    <div className='bg-primary-foreground/20 rounded-lg p-4 backdrop-blur-sm'>
                                        <div className='w-12 h-12 bg-primary-foreground/30 rounded-lg mb-3'></div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                        ...
                        <div className='text-center p-8 bg-card rounded-xl shadow-sm hover:shadow-md transition-shadow border border-border'>
                            ...
                            <p className='text-muted-foreground'>
                                ...
                                are always protected with bank-level security.
                            </p>
                        </div>
                        ...
                        <div className='text-center p-8 bg-card rounded-xl shadow-sm hover:shadow-md transition-shadow border border-border'>
                            ...
                            <p className='text-muted-foreground'>
                                All products come with our quality guarantee.
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-16'>
                        ...
                        <p className='text-xl text-muted-foreground'>
                            Discover our hand-picked selection of trending
                            products
                        </p>
                    </div>
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                        {[
                            {
                                name: "Sarah Johnson",
                                review: "Amazing quality and fast shipping! I've been shopping here for months and never disappointed.",
                                rating: 5,
                            },
                            {
                                name: "Mike Chen",
                                review: "Great customer service and competitive prices. Highly recommend this store to everyone.",
                                rating: 5,
                            },
                            {
                                name: "Emma Williams",
                                review: "Love the variety of products and the user-friendly website. Shopping here is a pleasure!",
                                rating: 5,
                            },
            ...
            <section className='py-20 bg-primary'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
                    ...
                    <p className='text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto'>
                        ...
                        about new products, exclusive deals, and special offers.
                    </p>
            ...
            <footer className='bg-card text-foreground py-16 border-t border-border'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    <div className='border-t border-border mt-12 pt-8 text-center'>
                        <p className='text-muted-foreground'>
                            © 2025 ShopHub. All rights reserved. | Privacy
